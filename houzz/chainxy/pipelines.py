...
class ChainxyPipeline(object):
    ...
    def __init__(self):
        ...
        self.headers = ['Company name', 'Contact first name', 'Contact last name', 'Unit & street (incl. suite)', 'City', 'Province', 'Postal code', 'Contact phone #', 'Website', '# of reviews', 'Rating (stars)']
